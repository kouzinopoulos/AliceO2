// @(#) $Id: HoughBaseTransformer.h 15995 2006-11-30 17:45:45Z hristov $
...
public:
  ...
  HoughBaseTransformer(Int_t slice, Int_t patch, Int_t netasegments, Float_t zvertex = 0.0);
  virtual ~HoughBaseTransformer();
  ...
  HoughBaseTransformer* GetLastTransfromer() const { return fLastTransformer; }
  ...
  void SetLastTransformer(HoughBaseTransformer* transformer) { fLastTransformer = transformer; }
...
protected:
  HoughBaseTransformer* fLastTransformer; // Pointer to the previous hough transformer
...
typedef HoughBaseTransformer AliL3HoughBaseTransformer; // for backward comapatibility
}
}
