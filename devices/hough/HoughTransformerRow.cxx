// @(#) $Id: HoughTransformerRow.cxx 15995 2006-11-30 17:45:45Z hristov $
...
Float_t HoughTransformerRow::fgBeta1 = 1.0 / Transform::Row2X(84);
Float_t HoughTransformerRow::fgBeta2 =
  1.0 / (Transform::Row2X(158) * (1.0 + tan(Transform::Pi() * 10 / 180) * tan(Transform::Pi() * 10 / 180)));
Float_t HoughTransformerRow::fgDAlpha = 0.22;
Float_t HoughTransformerRow::fgDEta = 0.40;
Double_t HoughTransformerRow::fgEtaCalcParam1 = 1.0289;
Double_t HoughTransformerRow::fgEtaCalcParam2 = 0.15192;
Double_t HoughTransformerRow::fgEtaCalcParam3 = 1. / (32. * 600. * 600.);

HoughTransformerRow::HoughTransformerRow()
{
  // Default constructor
  fParamSpace = 0;
...
HoughTransformerRow::HoughTransformerRow(Int_t slice, Int_t patch, Int_t netasegments, Bool_t /*DoMC*/, Float_t zvertex)
  : HoughBaseTransformer(slice, patch, netasegments, zvertex)
{
  // Normal constructor
  fParamSpace = 0;
...
void HoughTransformerRow::DeleteHistograms()
{
  // Clean up
  if (!fParamSpace)
    return;
...
void HoughTransformerRow::Reset()
{
...
Int_t HoughTransformerRow::GetEtaIndex(Double_t eta) const
{
...
inline Accumulator* HoughTransformerRow::GetHistogram(Int_t etaindex)
{
...
Double_t HoughTransformerRow::GetEta(Int_t etaindex, Int_t /*slice*/) const
{
...
Int_t HoughTransformerRow::GetTrackLength(Double_t alpha1, Double_t alpha2, Int_t* rows) const
{
...
inline void HoughTransformerRow::FillClusterRow(UChar_t i, Int_t binx1, Int_t binx2, UChar_t* ngaps2,
                                                UChar_t* currentrow2, UChar_t* lastrow2
#ifdef do_mc
                                                ,
...
inline void HoughTransformerRow::FillCluster(UChar_t i, Int_t etaindex, AliHLTEtaRow* etaclust, Int_t ilastpatch,
...
#ifdef do_mc
inline void HoughTransformerRow::FillClusterMCLabels(AliHLTDigitData digpt, AliHLTEtaRow* etaclust)
{
  // The method is a part of the fast hough transform.
...
void HoughTransformerRow::SetTransformerArrays(HoughTransformerRow* tr)
{
